        ...
        <div className="card-panel">
          <div className="row">
            ...
            <div className="col m9 s12">
              ...
              <p>The GreenlightVR API is a (relatively) straightforward REST service that allows developers to access data in the <a href="http://www.ingreenlight.com/" target="_blank">GreenlightVR</a>.</p>

              <h5 className="card-sub-title">1. Request an API Key</h5>
              <p>We review every request for access to the GreenlightVR Dataset and provision API Keys manually, so please answer the questions on the form as completely as possible.</p>
              ...
              <p>Please take a moment to read Using the API to make sure you understand the core principals guiding all interaction with the GreenlightVR REST API.</p>
              ...
              <p>Having troubles? Ask the community over at <a href="https://groups.google.com/" target="_blank">GreenlightVR API Google Group</a> or write to us at <a href="mailto:info@greenlightvr.com">info@greenlightvr.com</a></p>
            </div>
          </div>
        </div>
      </div>
