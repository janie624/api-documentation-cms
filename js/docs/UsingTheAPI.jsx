        ...
        <div className="card-panel">
          <div className="row">
            ...
            <div className="col m9 s12">
              ...
              <p>The GreenlightVR API is a RESTful service that enables approved developers to retrieve data from the GreenlightVR Dataset.</p>
              <p>The GreenlightVR API can be accessed programmatically (the most common use case), and a number of developers have written Language-Specific Libraries to jump-start your development.</p>
              <p>For simple testing / inspection, the GreenlightVR API can also be accessed through any web browser capable of displaying JSON.</p>

              <h5 className="card-sub-title">Authentication</h5>
              <p>The GreenlightVR API uses token-based authentication, which means that developers must pass their individual user_key parameter with every request. An example request for the /organizations endpoint would read as follows:</p>
              ...
              <p>The GreenlightVR API provides Item Search endpoints to retrieve the properties of an item by it’s name</p>
